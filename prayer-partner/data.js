window.AMICUS_DIRECTORY = {
  preschool: {
    name: "유아-유치부",
    english: "AMICUS PRESCHOOL",
    range: "만 2세-4세",
    message: "만 2세부터 4세까지 함께 예배합니다.",
    image: "assets/department-preschool-2026.png",
    imageAlt: "유아-유치부의 작은 시작을 상징하는 나무 블록과 식물",
    introduction: "유아부는 만 2세부터 4세까지의 아이들이 안전하고 기쁘게 하나님을 경험하도록 섬깁니다.",
    prayerPoints: [
      "아이들이 어려서부터 하나님을 잘 알고, 하나님의 축복과 사랑을 풍성히 경험하도록",
      "아이들의 몸과 마음과 믿음이 하나님 안에서 날마다 자라고 주님의 손길로 보호받도록",
      "유아부와 유치부 간사들에게 아이들을 잘 섬길 수 있는 지혜를 더해 주시도록"
    ],
    students: [
    ...
    staff: [
      { id: "preschool-jihye", name: "이지혜", school: "유아부", grade: "담당 간사", bio: "유아부 아이들이 어려서부터 하나님을 알고 사랑 안에서 자라도록 섬깁니다.", prayer: "우리 아이들이 어려서부터 하나님을 잘 알고, 하나님의 축복과 사랑을 넘치도록 경험하며 자라갈 수 있도록, 또한 저에게도 지혜를 주셔서 아이들을 잘 섬길 수 있도록 함께 기도해 주세요.", photo: "assets/staff-prayer-requests-2026.jpg", photoPosition: "22% 3%" },
      { id: "preschool-hyangsook", name: "김향숙", school: "유치부", grade: "담당 간사", bio: "유치부 아이들의 몸과 마음과 믿음이 하나님 안에서 건강하게 자라도록 섬깁니다.", prayer: "우리 아이들의 몸과 마음, 믿음이 하나님 안에서 날마다 자라가게 하시고, 언제나 주님의 손길로 지켜주실 수 있도록 함께 기도해 주세요.", photo: "assets/staff-prayer-requests-2026.jpg", photoPosition: "22% 26%" }
    ]
  },
  elementaryJr: {
    name: "유년부",
    english: "AMICUS KIDS",
    range: "만 5세-2학년",
    message: "만 5세부터 2학년까지 함께 예배합니다.",
    image: "assets/department-kids-2026.png",
    imageAlt: "유년부의 성장을 상징하는 열린 노트와 어린 식물",
    introduction: "유년부는 만 5세부터 2학년까지의 아이들이 말씀과 기도의 기초를 즐겁게 배우도록 돕습니다.",
    prayerPoints: [
      "아이들의 믿음의 뿌리가 말씀과 기도 안에 단단히 심어지도록",
      "아미쿠스 아이들이 학교와 일상에서 이웃을 사랑하는 마음으로 살아가도록",
      "간사와 교사들이 아이들의 이야기를 잘 듣고 믿음의 성장을 세심히 돌보도록"
    ],
    students: [
    ...
    staff: [
      { id: "elementary-jr-eunhye", name: "박은혜", school: "유년부", grade: "담당 간사", bio: "아이들의 믿음의 뿌리가 말씀 안에 단단히 심어지고 이웃 사랑을 실천하도록 섬깁니다.", prayer: "우리 아이들의 믿음의 뿌리가 단단히 잘 심어지고, 아미쿠스 아이들이 이웃을 사랑하는 마음을 가지며 살아갈 수 있도록 함께 기도해 주세요.", photo: "assets/staff-prayer-requests-2026.jpg", photoPosition: "22% 47.5%" }
    ]
  },
  elementary: {
    name: "초등부",
    english: "AMICUS ELEMENTARY",
    range: "3학년-5학년",
    message: "3학년부터 5학년까지 함께 예배합니다.",
    image: "assets/department-elementary-2026.png",
    imageAlt: "초등부의 성장을 상징하는 노트와 자라나는 덩굴 식물",
    introduction: "초등부는 3학년부터 5학년까지의 아이들이 말씀을 스스로 삶에 적용하고 공동체 안에서 책임감을 배우도록 동행합니다.",
    prayerPoints: [
      "아이들이 교회를 통해 하나님을 지식이 아닌 나의 하나님으로 알아가도록",
      "하나님 안에서 기쁨을 누리며 즐거운 신앙생활을 이어가도록",
      "학교와 친구 관계 속에서도 말씀을 삶으로 연결하고 사랑을 실천하도록"
    ],
    students: [
    ...
    staff: [
      { id: "elementary-jinju", name: "백진주", school: "초등부", grade: "담당 간사", bio: "아이들이 교회를 통해 나의 하나님을 알아가고 기쁨으로 신앙생활을 하도록 섬깁니다.", prayer: "우리 아이들이 교회를 통해 나의 하나님을 알아가기를 원하고, 하나님 안에서 기쁨을 누리며 즐거운 신앙생활을 할 수 있도록 함께 기도해 주세요.", photo: "assets/staff-prayer-requests-2026.jpg", photoPosition: "22% 70.2%" }
    ]
  },
  youth: {
    name: "중고등부",
    english: "AMICUS YOUTH",
    range: "6학년-12학년",
    message: "6학년부터 12학년까지 함께 예배합니다.",
    image: "assets/department-youth-2026.png",
    imageAlt: "중고등부의 여정을 상징하는 지도와 나침반",
    introduction: "중고등부는 6학년부터 12학년까지의 청소년들이 학교와 진로, 관계의 선택 속에서 믿음을 자신의 언어로 살아내도록 동행합니다.",
    prayerPoints: [
      "학생들이 하나님을 뜨겁게 사랑하고 인격적으로 깊이 만나도록",
      "믿음이 자라 학교와 관계, 진로의 선택 속에서 말씀을 살아내도록",
      "삶 속에서 건강하고 성숙한 신앙생활을 이어가도록"
    ],
    students: [
    ...
    staff: [
      { id: "youth-myoungchul", name: "박명철", school: "중고등부", grade: "담당 강도사", bio: "청소년들이 하나님을 인격적으로 만나고 삶으로 믿음을 살아내도록 동행합니다.", prayer: "중고등부 아이들이 하나님을 뜨겁게 사랑하며, 인격적으로 하나님을 깊이 만나고, 믿음이 자라 삶 속에서 건강하고 성숙한 신앙생활을 살아갈 수 있도록 함께 기도해 주세요!", photo: "assets/staff-prayer-requests-2026.jpg", photoPosition: "22% 92%" }
    ]
  }
};

// 실제 등록부의 부서 구조를 반영한 매칭 데이터입니다.
// 실제 학생 명단은 공개 자바스크립트에 넣지 말고 인증된 데이터베이스에서 한 명씩 반환해야 합니다.
window.AMICUS_MATCHING_DEPARTMENTS = {
  preschool: {
    name: "유아-유치부",
    english: "AMICUS PRESCHOOL",
    code: "유치",
    range: "만 2세-4세",
    registryCount: 8,
    students: window.AMICUS_DIRECTORY.preschool.students
  },
  elementaryJr: {
    name: "유년부",
    english: "AMICUS KIDS",
    ...
    range: "만 5세-2학년",
    registryCount: 10,
    students: window.AMICUS_DIRECTORY.elementaryJr.students
  },
  elementary: {
    name: "초등부",
    english: "AMICUS ELEMENTARY",
    ...
    range: "3학년-5학년",
    registryCount: 4,
    students: window.AMICUS_DIRECTORY.elementary.students
  },
  youth: {
    name: "중고등부",
    english: "AMICUS YOUTH",
    ...
    range: "6학년-12학년",
    registryCount: 25,
    students: window.AMICUS_DIRECTORY.youth.students
  }
};

window.AMICUS_STORAGE = {
  applications: "amicus-partner-applications-v6",
  currentAssignment: "amicus-current-assignment-v6",
  qrTarget: "amicus-qr-target-v6",
  emailVerification: "amicus-email-verification-v1"
};
